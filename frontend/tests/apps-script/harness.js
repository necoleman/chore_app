...
export const HEADERS = {
  ...
  Chores: ['chore_id', 'name', 'location', 'description', 'points', 'frequency', 'weekday_due', 'monthly_day', 'monthly_week', 'interval_days', 'once_date', 'start_date', 'lead_days', 'sort_last', 'last_generated_date', 'default_assignee', 'rotation_last', 'requires_approval', 'active'],
