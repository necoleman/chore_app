...
export const HEADERS = {
  ...
  Chores: ['chore_id', 'name', 'location', 'description', 'points', 'frequency', 'custom_days', 'monthly_day', 'monthly_week', 'monthly_weekday', 'interval_days', 'once_date', 'start_date', 'last_generated_date', 'default_assignee', 'requires_approval', 'active'],
