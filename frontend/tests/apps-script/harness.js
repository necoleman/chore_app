...
export const HEADERS = {
  ...
  Chores: ['chore_id', 'name', 'location', 'description', 'points', 'frequency', 'custom_days', 'monthly_day', 'monthly_week', 'monthly_weekday', 'interval_days', 'once_date', 'start_date', 'lead_days', 'recur_mode', 'last_generated_date', 'default_assignee', 'rotation_last', 'requires_approval', 'active'],
