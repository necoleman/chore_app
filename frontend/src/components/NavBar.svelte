...
<nav class="navbar">
  ...
  <!-- Visible to everyone. Non-admins get a read-only view whose only control is
       the per-chore Add button, so they can pull a chore onto Today without
       being able to create or alter one. ChoresAdmin gates the rest. -->
  <a href="/admin/chores" use:link class:active={$location === '/admin/chores'} aria-label="Chores">
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
